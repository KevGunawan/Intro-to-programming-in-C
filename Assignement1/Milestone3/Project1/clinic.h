...
int available(struct Date date, struct Time time, struct Appointment* app, int maxAppointments);

//checks if the next slot is available and returns index value
int availableSpot(struct Appointment* app, int maxAppointments);
